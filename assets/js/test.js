...
const jsonFileUrl = '../data/data_product.json';
...
// var shuffledProduct = shuffle(product);

// var numberOfItemsToShow = 25;

// renderItem(product,numberOfItemsToShow);
// responsive();
// handlePagination();


// 3. Hiển Thị Sản Phẩm:main product
function renderItem(items,limit) {
  var listProduct = document.getElementById('list-product');
  var htmls = items.slice(0,limit).map(function (item) {
    return `
